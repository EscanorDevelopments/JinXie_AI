document.addEventListener('DOMContentLoaded', () => {
  ...
      // Elemen untuk Sidebar Toggle (#sidebar-toggle) dan App Container (.app012740712037container0812701230)
      // Kode untuk toggle sidebar masih ada di sini, pastikan elemen ini ada di HTML Anda
      const sidebarToggle = document.getElementById('sidebar-toggle');
      const appContainer = document.querySelector('.app012740712037container0812701230');
  ...
          }
      } else {
          console.warn('Sidebar toggle button (#sidebar-toggle) or app container (.app012740712037container0812701230) not found. Sidebar toggle feature disabled.');
      }
